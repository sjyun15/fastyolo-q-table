...
bind-key -n C-F2 new-window -c "#{pane_current_path}" \; rename-window "-"
bind-key -n F2 display-panes \; split-window -h -c "#{pane_current_path}"
bind-key -n F3 display-panes \; split-window -v -c "#{pane_current_path}"
bind-key -n C-S-F2 new-session
bind-key -n S-F2 previous-window
